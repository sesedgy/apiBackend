...
namespace DataBaseModel.Models
{
    public class Student
    {
        ...
        public string LastNameDP { get; set; }      //Дательный падеж
        public string FirstNameDP { get; set; }     //Дательный падеж
        public string MiddleNameDP { get; set; }    //Дательный падеж
        ...
        public string DisciplinePlus { get; set; }
        public string DisciplineMinus { get; set; }
        ...
        public string PhotoDiplomPath { get; set; }
        public string PhotoPassport1Path { get; set; }
        public string PhotoPassport2Path { get; set; }
        public string PhotoPassportCustomer1Path { get; set; }
        public string PhotoPassportCustomer2Path { get; set; }
        public string PhotoСertificateOfMilitary1Path { get; set; }
        public string PhotoСertificateOfMilitary2Path { get; set; }
